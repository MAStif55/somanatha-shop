...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .desc { font-size: 11px; line-height: 1.2; font-weight: 600; display: flex; align-items: center; justify-content: center; gap: 6px; margin-top: 2px; }
...
<body>
    ...
    <div class="label-container">
        ...
        <div class="text-side">
            ...
            <div class="desc">
                <img src="${window.location.origin}/logo.png" style="height: 14px; width: auto; object-fit: contain; filter: brightness(0);" />
